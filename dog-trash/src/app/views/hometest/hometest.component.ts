...
//   ngOnInit() {
//       this.images = [];
//       this.images.push({source:'assets/images/galleria1.png', alt:'Description for Image 1', title:'Title 1'});
//       this.images.push({source:'assets/images/galleria2.png', alt:'Description for Image 2', title:'Title 2'});
